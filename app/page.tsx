...
export default function Home() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (data.error) {
        // Map known API error codes to user-friendly messages.
        // data.message is populated by the API for provider_overloaded and similar.
        const msg: string =
      ...
      // Auto-fill industry / function from AI analysis if user hasn't typed them
  ...
  async function handleCreateProjectBrief() {
    ...
    try {
      ...
      // Step 2: PATCH optional brief extras if provided
